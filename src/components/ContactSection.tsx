              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-4 rounded-xl hover:bg-primary/10 transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">svinothkumar0301@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-xl hover:bg-primary/10 transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Tiruchengode, Namakkal, Tamil Nadu, India</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-border">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    ...
                    className="bg-primary/20 p-3 rounded-xl hover:bg-primary hover:scale-110 transition-all duration-300 group"
                  >
                    <Github className="text-primary group-hover:text-white" size={20} />
                  </a>
                </div>
              </div>
            </div>
